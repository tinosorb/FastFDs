...
// 					//time_ref.put(lattice.elementAt(i), second);
...
// 					//	 query + " time used(ms): " + (System.currentTimeMillis() - temp_time));
// 				}
...
// 					}
// 				}
// 				//System.out.println("smaller is " + rtn + " bigger is " + all_bit);
...
// 			//System.out.println("level time " + (System.currentTimeMillis()-l_start));
